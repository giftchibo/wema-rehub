...
$respacdoc = mysql_query("SELECT * FROM patient where patid='$_GET[patid]'");
 while($row26a = mysql_fetch_array($respacdoc))
{
	$regfee = $row26a["regfee"];
	$patid = $row26a["patid"];
}
$respacdoc = mysql_query("SELECT * FROM patienttriagy where patid='$_GET[patid]'");
 while($row26a = mysql_fetch_array($respacdoc))
{
	$consutationfee = $row26a["consutationfee"];
	$emp= $row26a["empid"];
}
$respacdoc = mysql_query("SELECT * FROM prescription where patid='$_GET[patid]'");
 while($row26a = mysql_fetch_array($respacdoc))
{
	$presid = $row26a["presid"];
	$precfee= $row26a["precfee"];
}
...
<div id="container">
 ...
 <div align="center">
   ...
   <p><strong><u>WEMA REHUB CLINIC<br />
   </u></strong><br />
   MOMBASA ROAD, Mombasa - 57<br />
   <strong><br />
     INVOICE</strong></p>
</div>
 <br />
 ...
 <table width="1000" border="0" align="center">
   ...
   <tr>
     ...
     <td align="right" valign="top">Date : <?php echo date("d-M-Y"); ?> <br />       Place : MOMBASA</td>
     </td>
   </tr>
   <tr>
...
$labfee = 0;
     ...
     <td>&nbsp;<?php echo "ksh. ". $rowlab["labfee"] . ".00"; 
 $labfee = $labfee + $rowlab["labfee"]
  ...
  ?>
   <tr>
     ...
     <td>&nbsp;<?php echo "ksh. ". $totfee= $labfee + $treatfee1 . ".00"; ?></td>
   </tr>
   <tr>
     <td colspan="2">&nbsp;
     <?php
