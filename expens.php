...
<div id="main">
 ...
 ?>
      ...
      <table width="600" border="1">
        <tr>
            <th width="80" height="42" scope="col"><font color="#0000FF">Expense Type</font></th>
          ...
          while($row1 = mysql_fetch_array($resapp))
  {
	  ...
	  ?>
          <tr>
            ...
            <td width="11"><a href="expens.php?expensetype=<?php echo $row1[expensetype];?>&quantity=<?php echo $row1[quantity];?>&date=<?php echo $row1[date];?>" ><img src="images/icons/remove.png" alt="" width="32" height="32"></a></td>
          </tr>
          <?php
          }
		  ?>
    </table>
      <p>&nbsp;<a href="cashier.php"> << Back</a></p>
