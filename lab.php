...
<ul>
			...
			<li><a href="lab.php">Dashboard</a></li>
...
<!-- Dashboard icons -->
            <div class="grid_7">
            	<a href="lab.php" class="dashboard-module">
                	<img src="images/images.jpg" width="100" height="100" alt="edit" />
                	<span>Dashboard</span>
                </a>
				...
				<a href="empappview.php"target="_top" class="dashboard-module">
                	<img src="images/next.gif" width="100" height="100" alt="edit" />
                	<span>appointment</span>
					</a>
				<a href="emplab.php"target="_top" class="dashboard-module">
                	<img src="images/laboratory.jpg" width="100" height="100" alt="edit" />
                	<span>laboratory</span>
					</a>
				<a href="doctimingsview.php"target="_top" class="dashboard-module">
                	<img src="images/clock.gif" width="100" height="100" alt="edit" />
                	<span>timings</span>
					</a>
				
				<a href="expens.php"target="_top" class="dashboard-module">
                	<img src="images/invoic_ 1.jpg" width="100" height="100" alt="edit" />
                	<span>expenses</span>
					</a>
