...
<form id="formID" class="formular" method="post">
 ...
 <label for="textfield2">addiction type</label>
      <input type="text" name="pln" id="textfield2" class="validate[required,custom[onlyLe
      <label for="textfield4">Password<font color="#009933" size="2">(  )</font></label>
