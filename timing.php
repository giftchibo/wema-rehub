...
header("patientaccount.php");
 ...
 <form method="post" action="">
     <table width="600" border="1">
       <tr>
         <th width="80" align="center"><strong>Morning</strong></th>
         <th width="95" align="center"><strong>Afternoon</strong></th>
         <th width="170" align="center"><strong>Evening</strong></th>
       </tr>
       <tr>
...
?> />
     ...
     <a href="doctor.php"> < < Back </a><h2>&nbsp;</h2>
<div id="respond"></div>
    </div>
