...
<html>
<head>
<title><?php $user?> wema rehub System</title>
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/hd_logo.jpg"></a> Wema rehub system Sys</h1></div>
<div id="left_column">
<div id="button">
		<ul>
			...
			<li><a href="billing.php">viewbillingperfomed</a></li>
...
<hr/>	
    <div class="tabbed_area">  
        ...
        <ul class="tabs">  
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">doctor</a></li>  
...
<?php echo $message;
       ...
       $result = mysql_query("SELECT * FROM doctor")or die(mysql_error());
        ...
        echo "<tr><th>docid</th> <th>doctorname </th> <th>quali</th><th>specialistin</th><th>password</th></tr>";
...
?> 
		...
		*/
        ...
        echo "<table border='1' cellpadding='5' >";
         echo "<tr><th>Firstname</th> <th>Lastname </th> <th>staff_id</th><th>Phone</th><th>Email</th><th>Username </th></tr>";
