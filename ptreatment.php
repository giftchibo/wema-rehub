...
{
$resultpatientrec = mysql_query("SELECT * FROM  treatment where treid='$_POST[textfield]'");
$_POST[textfield2] ="";
}
else if(isset($_POST["patcontbtn"]))
{
	$resultpatientrec = mysql_query("SELECT * FROM  treatment where docid='$_POST[textfield2]'");
		$_POST[textfield]="";
}
else
{
...
<form method="post" action="" id="formID">
     ...
     <strong>Search by TreatmentID</strong>
   ...
   <input type="text" name="textfield2" id="textfield2" class="validate[custom[onlyNumberSp]] text-input" value="<?php echo $_POST[textfield2]; ?>"/> 
	  ...
	  <tr>
          ...
          <th width="107" height="30" scope="col"><font color="#0000FF">treatmentid</font></th>
          <th width="107" scope="col"><font color="#0000FF">doctorid</font></th>
		  <th width="107" scope="col"><font color="#0000FF">treatmentfee</font></th>
          <th width="107" scope="col"><font color="#0000FF">treatment</font></th>
          <th width="107" scope="col"><font color="#0000FF">date</font></th>
          <th width="107" scope="col"><font color="#0000FF">time</font></th>
          <th width="107" scope="col"><font color="#0000FF">appointmentid</font></th>
          ...
          while($row= mysql_fetch_array($resultpatientrec))
  {
	  ...
	  ?> 
		 ...
		 <td><?php echo $row["treatfee"]; ?></td>
          ...
          <td width="44" ><a href="patientmorereport.php?paid=<? echo $row1[patid];?>" ><img src="images/more.jpg"  /></a></td>
